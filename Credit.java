...
public class Credit extends HttpServlet
{
	public void service(HttpServletRequest req , HttpServletResponse res)throws IOException , ServletException
	{
		...
		long creditamount=Long.parseLong(req.getParameter("creditamount"));
		...
		try{
			...
			while(rs.next()){
			      ...
			      long newbalance=amount+creditamount;
			...
			RequestDispatcher disp=req.getRequestDispatcher("/BS_page-Credit.html");
