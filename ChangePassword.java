	...
	public void service(HttpServletRequest req , HttpServletResponse res)throws IOException , ServletException
	{
		...
		try{
			...
			while(rs.next()){
			      ...
			      {
				s.executeUpdate("update BankEmployee set USERPASS='"+newpassword+"' where USERNAME='"+username+"'");
			...
			RequestDispatcher disp=req.getRequestDispatcher("/BS_page-ChangePassword.html");
